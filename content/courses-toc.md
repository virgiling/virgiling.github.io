...
这里收录了我在 [csdiy](https://csdiy.wiki) 上学习的一系列公开实验（当然，也有一部分不在这个网站上收录），归档参考 [[01-courses/index|📖公开课目录]]
...
### #公开课/MIT/6-S081 Operating System Engineering
...
更多信息可以参考 [[01-courses/MITOS/index|课程简介]]

## Medium Version 🌶️🌶️🌶️~🌶️🌶️🌶️🌶️

### #公开课/SJTU/SE-315 Operating Systems
...
更多信息可以参考 [[01-courses/chcore/index|课程简介]]

### #公开课/NJU/OS Operating Systems
...
更多信息可以参考 [[01-courses/NJUOS/index|课程简介]]

### #公开课/PKU/OS Operating Systems

这门课程是 csdiy 的作者基于 UCB 的 CS162 魔改的，而 CS162 号称难度上不封顶

更多信息可以参考 [[01-courses/PKUOS/index|课程简介]]
...
## #公开课/Stanford/CS144 Computer Network
...
## #公开课/MIT/6-824 Distributed System

这门课和 #公开课/MIT/6-S081 一样，出品自 MIT 大名鼎鼎的 PDOS 实验室，授课老师 Robert Morris 教授曾是一位顶尖黑客，世界上第一个蠕虫病毒 Morris 病毒就是出自他之手，目前这个课程已经变成了面试简历上的必备项目，几乎是每个人都有（

# 数据库

## #公开课/CMU/15-445 Database Systems

这是一门质量极高，资源极齐全的 Database 入门课，这门课的 Faculty 和背后的 CMU Database Group 将课程对应的基础设施 (Autograder, Discord) 和课程资料 (Lectures, Notes, Homework) 完全开源，让每一个愿意学习数据库的同学都可以享受到几乎等同于 CMU 本校学生的课程体验，和 #公开课/MIT/6-824 一样，这个课程也已经称为简历必备项，虽然做完的人并没有那么多，可能只是配了环境就写上去了也说不准。
