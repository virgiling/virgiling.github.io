...
中文 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai)，代码 [Monaco](https://github.com/thep0y/monaco-nerd-font)，配置的方法如下：打开设置后（`Ctrl + ,`），在用户的部分写下如下设置（注意是在 `Windows` 环境下）
...
![image.png|825](https://virgil-civil-1311056353.cos.ap-shanghai.myqcloud.com/img/20250415195909975.png)
