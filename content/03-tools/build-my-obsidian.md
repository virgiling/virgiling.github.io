...
> [!tip] 分类
>
> 当然，分类本身就是一门哲学（不知道这个词是否合适），本质上我们并不需要太细的分类。
> 你也可以参考网络上其他人的分类方式，但是我十分建议在分类（无论是文件夹还是标签）上多思考。
> 分类时思考的越多，检索时思考的越少
...
![image.png|250](https://virgil-civil-1311056353.cos.ap-shanghai.myqcloud.com/img/20250926215413229.png)
...
6. tasks 主要是用了 [Tasks](https://publish.obsidian.md/tasks/Introduction) 这个插件，用于分类总结我的 Todo List
7. project 是个人所做的一些项目文档，由于可能有不能公开的原因，也没同步到 git 中

> [!tip]
> 文件夹前面的序号只是为了字典序的排序所加的前缀

## Tags 组织

这是我目前正在结合目录法使用的方法，在 [[build-my-obsidian#Tags|上文]] 中，我们已经提到标签可以实现一个树形结构，因此我们可以使用标签来构建一个目录树，如下图所示：

![image.png|300](https://virgil-civil-1311056353.cos.ap-shanghai.myqcloud.com/img/20250926215853285.png)
...
> [!important] 
> 在 Obsidian 的 1.9 版本发布了 Base 的功能，这个功能可以很好的替代 `dataview` 所提供的部分功能，而且 Quartz 也把支持这个功能[纳入了计划](https://github.com/jackyzha0/quartz/issues/1995)

# 链接

本质上 Obsidian 还是以链接为主题，你甚至可以只需要拥有两个文件夹：

1. inbox
2. archive

一个来放置没有写完的内容，一个来放置已经输出的知识

这样，我们可以在每次打开 Obsidian 时通过漫游笔记之间的链接来复习/得到新的启发

因此在输出知识时，可以多思考思考当前内容和库内其他笔记是否存在某种联系，是否可以将它们直接/间接联系起来
