...
Virgil, 一个活的相对失败的 `CSer`，会的东西很多但没有一样说得上很明白，上过很多课但大多也用不上，记得的事情很多但大多是零零碎碎，目前正在 NENU 读研 😶

性格是 INTP 的 I 和 P，但除此之外没有任何地方与 INTP 类似，相反做事会比较感性，也没什么思考

喜欢的歌手和乐队都很多，Vanudy, milet, Fujii Kaze, Yorushika, Atarayo, ztmy, mygo, kessoku band, nishina, 胡子男, 刺猬，但最喜欢的还是拧巴男在的 `Yorushika` 了
...
详细参见 [Scholar](https://scholar.google.com/citations?user=2KON72wAAAAJ&hl=en)

- [A Multi-start Algorithm with Iterated Decremental Local Search for Minimum Capacitated Dominating Set Problem in Large Graphs](https://link.springer.com/article/10.1007/s12293-025-00470-6)
...
- 以技术支持的身份协助举办了 [[Intro-To-Provincial-Contest|2023 CCPC 吉林省赛环境配置]]，2024 CCPC 吉林省赛与东北四省赛

- 在  [[02-research/22-notes/ML-Sys/index|ICT 简单实习]] 了一个多月，学习了一些 #Research/笔记/ML-Sys 的内容
...
- [x] SJTU Operating System

- [x] PKU Operating System(UCB CS162)
...
- [x] NENU Data Structure---(82/100) 😭

- [x] NENU Probability Theory And Mathematical Statistics---(88/100) 😡

- [x] NENU Discrete Mathematics(II)---(86/100) 😭

- [x] NENU Algorithm & Computer Programming(II)---(98/100)

- [x] NENU C Programming Language---(88/100) 😅

- [x] NENU Introduction To Computer Science---(91/100)

- [x] NENU Linear Algebra---(88/100) 😡
