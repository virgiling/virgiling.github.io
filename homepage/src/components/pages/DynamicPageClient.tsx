...
export type DynamicPageLocaleData =
  | { type: 'people'; config: PublicationPageConfig; publications: Publication[] }
...
export default function DynamicPageClient({ dataByLocale, defaultLocale }: DynamicPageClientProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {pageData.type === 'people' && (
        <PeopleGraph config={pageData.config} publications={pageData.publications} />
      )}
      {pageData.type === 'text' && (
