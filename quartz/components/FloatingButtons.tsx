    ...
    return (
      <div class={classNames(displayClass, "floating-buttons", `floating-${position}`)}>
        <div class="button-group">
          <button class="floating-button" title="回到顶部" data-action="scrollTop">
          ...
          <button class="floating-button" title="滚动到底部" data-action="scrollBottom">
          ...
          <button class="floating-button" title="全局图谱" data-action="graph">
